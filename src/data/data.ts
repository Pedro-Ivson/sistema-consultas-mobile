...
export const MEDICOS: Medico[] = [
  {
    ...
    nome: "Dra. Ana Souza",
    crm: "123456-SP",
    especialidade: especialidadePorId(1),
    ativo: true,
  },
  {
    id: 2,
    nome: "Dr. Bruno Lima",
    crm: "234567-SP",
    especialidade: especialidadePorId(2),
    ativo: true,
  },
  {
    id: 3,
    ...
    crm: "345678-SP",
    especialidade: especialidadePorId(3),
    ativo: true,
  },
  {
    id: 4,
    nome: "Dr. Diego Alves",
    crm: "456789-SP",
    especialidade: especialidadePorId(4),
    ativo: true,
  },
  {
    id: 5,
    nome: "Dra. Elena Castro",
    crm: "567890-SP",
    especialidade: especialidadePorId(5),
    ativo: true,
  },
  {
    id: 6,
    nome: "Dr. Fabio Nunes",
    crm: "678901-SP",
    especialidade: especialidadePorId(6),
    ativo: true,
  },
  {
    id: 7,
    nome: "Dra. Gabriela Dias",
    crm: "789012-SP",
    especialidade: especialidadePorId(7),
    ativo: true,
  },
  {
    id: 8,
    ...
    crm: "890123-SP",
    especialidade: especialidadePorId(8),
    ativo: true,
  },
  {
    id: 9,
    nome: "Dra. Isabel Freitas",
    crm: "901234-SP",
    especialidade: especialidadePorId(9),
    ativo: true,
  },
  {
    id: 10,
    ...
    crm: "112233-SP",
    especialidade: especialidadePorId(10),
    ativo: true,
  },
];
